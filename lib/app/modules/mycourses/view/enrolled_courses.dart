      ...
      child: Scaffold(
        ...
        body: Obx(
          () => controller.isLoading.value == true
              ...
              : controller.courseController.enrolledCoursesList.isEmpty
                  ? SingleChildScrollView(
                      physics: const AlwaysScrollableScrollPhysics(),
                      child: SizedBox(
                        height: Get.height - 140, // Adjust as needed
                        child: const Center(
                          child: Text(
                          ...
                          Expanded(
                            child: ListView.separated(
                              ...
                              itemCount: controller
                                  .courseController.enrolledCoursesList.length,
